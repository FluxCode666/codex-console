...
from .upload.fluxcode_services import router as fluxcode_services_router
...
api_router.include_router(fluxcode_services_router, prefix="/fluxcode-services", tags=["fluxcode-services"])
